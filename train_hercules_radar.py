...
parser.add_argument('--init_learning_rate', type=float, default=0.0005, 
...
parser.add_argument('--log_dir', default=f'STCLoc_{SEQUENCE_NAME}_Radar/',
...
parser.add_argument('--dataset', default='Hercules', 
                    help='Oxford or vReLoc')#todo 确定是不是Hercules
...
parser.add_argument('--skip_val', action='store_true', default=False,
                    help='if skip validation during training, default False') #todo
